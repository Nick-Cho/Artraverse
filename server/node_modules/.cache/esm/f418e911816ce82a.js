let User,hashPassword,comparePassword,jwt;_816‍.x([["register",()=>register],["login",()=>login]]);_816‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_816‍.w("../helpers/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["comparePassword",["comparePassword"],function(v){comparePassword=v}]]);_816‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
  ...
  try{
    ...
    _816‍.g.console.log('Register Error:', err);
