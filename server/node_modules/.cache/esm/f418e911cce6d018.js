let User,hashPassword,comparePassword,jwt;_cce‍.x([["register",()=>register],["login",()=>login],["currentUser",()=>currentUser],["forgotPassword",()=>forgotPassword]]);_cce‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_cce‍.w("../helpers/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["comparePassword",["comparePassword"],function(v){comparePassword=v}]]);_cce‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
  ...
  try{
    ...
    _cce‍.g.console.log('Register Error:', err);
