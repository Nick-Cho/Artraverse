let User,hashPassword,comparePassword,jwt;_899‍.x([["register",()=>register],["login",()=>login],["currentUser",()=>currentUser],["forgotPassword",()=>forgotPassword]]);_899‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_899‍.w("../helpers/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["comparePassword",["comparePassword"],function(v){comparePassword=v}]]);_899‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
  ...
  try{
    ...
    _899‍.g.console.log('Register Error:', err);
