let User,hashPassword,comparePassword,jwt,nanoid;_495‍.x([["register",()=>register],["login",()=>login],["currentUser",()=>currentUser],["forgotPassword",()=>forgotPassword],["profileUpdate",()=>profileUpdate],["findPeople",()=>findPeople],["addFollower",()=>addFollower],["userFollow",()=>userFollow]]);_495‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_495‍.w("../helpers/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["comparePassword",["comparePassword"],function(v){comparePassword=v}]]);_495‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_495‍.w("nanoid",[["nanoid",["nanoid"],function(v){nanoid=v}]]);
  ...
  try{
    ...
    _495‍.g.console.log('Register Error:', err);
