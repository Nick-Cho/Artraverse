let User,hashPassword,comparePassword,jwt,nanoid;_357‍.x([["register",()=>register],["login",()=>login],["currentUser",()=>currentUser],["forgotPassword",()=>forgotPassword],["profileUpdate",()=>profileUpdate],["findPeople",()=>findPeople]]);_357‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_357‍.w("../helpers/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["comparePassword",["comparePassword"],function(v){comparePassword=v}]]);_357‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_357‍.w("nanoid",[["nanoid",["nanoid"],function(v){nanoid=v}]]);
  ...
  try{
    ...
    _357‍.g.console.log('Register Error:', err);
